...
var version = "20220914-02";				//스크립트 버전정보
var autoFill = true;						//고객명 자동입력유무 (true=활성화/false=비활성화)
var __export_count = 1;						//출고번호 기본값
var __export_value = "";					//출고번호 Message
var content_header_title = getElementByXpath('/html/body/div[1]/div/div/main/div/section/div[1]/header/h1');		//메뉴헤더 텍스트가 담긴부분
...
function check_header_title(){
	content_header_title = getElementByXpath('/html/body/div[1]/div/div/main/div/section/div[1]/header/h1');
